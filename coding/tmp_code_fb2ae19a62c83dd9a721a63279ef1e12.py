...
# Convert the markdown to html and parse it with BeautifulSoup
soup = BeautifulSoup(markdown(table), 'html.parser')

# Export the html to a string for use with pandas
