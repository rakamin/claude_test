...
# Remove backticks and <br> tags
table = re.sub("`|<br>", "", table)

# Tabulate can parse markdown tables, but needs a file-like object
string_io = StringIO(table)
df = tabulate(string_io, format="pipe", headers="keys", tablefmt="psql")
